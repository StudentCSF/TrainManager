...
@Repository
public interface CrashOnStationRepository extends JpaRepository<CrashOnStationEntity, UUID> {

    List<CrashOnStationEntity> findAllByCrUid(UUID uid);

    Optional<CrashOnStationEntity> findByStUid(UUID uid);
